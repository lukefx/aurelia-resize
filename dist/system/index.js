System.register(['aurelia-framework'], function (_export) {
  ...
  var customAttribute, bindable, inject, ResizeEvent;
  ...
  return {
    ...
    execute: function () {
      ResizeEvent = (function () {
        ...
        ResizeEvent = bindable('throttle')(ResizeEvent) || ResizeEvent;
        ResizeEvent = bindable('handler')(ResizeEvent) || ResizeEvent;
        ResizeEvent = customAttribute('resize-event')(ResizeEvent) || ResizeEvent;
        ResizeEvent = inject(Element)(ResizeEvent) || ResizeEvent;
        return ResizeEvent;
      })();

      _export('ResizeEvent', ResizeEvent);
